...
#
# Requires shadow (useradd/groupadd/usermod) and sudo. Alpine uses the
# wheel group rather than a sudo group for administrative access.
...
grant_passwordless_sudo() {
  ...
  # Alpine convention: wheel is the admin group.
